...
from foundrytools_cli_ng.commands.print.font_info import main as print_font_info
from foundrytools_cli_ng.commands.print.font_names import main as print_names
