...
from foundrytools_cli_ng.utils import BaseCommand
...
def fix_legacy_accents(input_path: Path, **options: dict[str, Any]) -> None:
    ...
    """
    from foundrytools_cli_ng.commands.fix.legacy_accents import fix_legacy_accents as task
...
def fix_vertical_metrics(input_path: Path, **options: dict[str, Any]) -> None:
    ...
    from foundrytools_cli_ng.commands.fix.vertical_metrics import main as task
