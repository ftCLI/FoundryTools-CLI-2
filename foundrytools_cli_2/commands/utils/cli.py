...
from foundrytools_cli_2.utils import choice_to_int_callback, make_options
...
def font_renamer(input_path: Path, **options: dict[str, Any]) -> None:
    ...
    """
    from foundrytools_cli_2.commands.utils.font_renamer import main as task
...
def font_organizer(input_path: Path, **options: dict[str, Any]) -> None:
    ...
    from foundrytools_cli_2.commands.utils.font_organizer import main as task
...
def align_timestamps(input_path: Path, recursive: bool = False) -> None:
    ...
    from foundrytools_cli_2.commands.utils.sync_timestamps import main as task
