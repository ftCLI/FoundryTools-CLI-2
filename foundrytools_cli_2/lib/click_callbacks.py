...
def choice_to_int_callback(
    ...
    """
    Callback for click options that accept a choice. Converts the choice to an integer or a tuple of
    integers.

    If the value is None or the click context is resilient, returns None. If the parameter is
    multiple, converts a click choice tuple of strings to a tuple of integers. Otherwise, converts a
    click choice string to an integer.
    :param ctx: click Context
