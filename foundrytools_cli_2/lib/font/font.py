...
class Font:  # pylint: disable=too-many-public-methods
    ...
    def build_unique_identifier(
        ...
        if not alternate:
            ...
            postscript_name = name_table.get_debug_name(NAME_IDS.POSTSCRIPT_NAME)
            ...
            manufacturer_name = name_table.get_debug_name(NAME_IDS.MANUFACTURER_NAME)
            unique_id = f"{manufacturer_name}: {family_name}-{subfamily_name}: {year_created}"

        name_table.set_name(
            name_id=NAME_IDS.UNIQUE_FONT_IDENTIFIER, name_string=unique_id, platform_id=platform_id
        )
    ...
    def build_full_font_name(self, platform_id: t.Optional[int] = None) -> None:
        ...
        name_table.set_name(
            name_id=NAME_IDS.FULL_FONT_NAME, name_string=full_font_name, platform_id=platform_id
        )
    ...
    def build_version_string(self, platform_id: t.Optional[int] = None) -> None:
        ...
        name_table.set_name(
            name_id=NAME_IDS.VERSION_STRING, name_string=version_string, platform_id=platform_id
        )
    ...
    def build_postscript_name(self, platform_id: t.Optional[int] = None) -> None:
        ...
        name_table.set_name(
            name_id=NAME_IDS.POSTSCRIPT_NAME, name_string=postscript_name, platform_id=platform_id
        )
